public enum NecromancerAttackEnum
{
    ...
    MARK_OF_DEATH, // inflicts 970, heals self for 600, and enters Wrath mode (sending 1 curse to the enemy and draining 5% of their health for each of the 3 next rounds)
}